...
bool handlePackmanKeyPress(const sf::Event::KeyEvent& event, Packman& packman)
{
    ...
    switch (event.code)
    {
    case sf::Keyboard::W:   //TODO: смена с Up на W
        packman.direction = Direction::UP;
        break;
    case sf::Keyboard::S:   //TODO: смена с Down на S
        packman.direction = Direction::DOWN;
        break;
    case sf::Keyboard::A:   //TODO: смена с Left на A
        packman.direction = Direction::LEFT;
        break;
    case sf::Keyboard::D:   //TODO: смена с Right на D
